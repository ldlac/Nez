...
namespace Nez
{
    public static class EffectResource
    {
        ...
        internal static Effect SpriteLightMultiplyEffect => Core.Content.Load<Effect>("nez/effects/SpriteLightMultiply");
        ...
        internal static Effect DeferredSpriteEffect => Core.Content.Load<Effect>("nez/effects/DeferredSprite");

        internal static byte[] DeferredLightBytes => GetFileResourceBytes("Content/nez/effects/DeferredLighting.mgfxo");

        internal static Effect DeferredLightEffect => Core.Content.Load<Effect>("nez/effects/DeferredLighting");
