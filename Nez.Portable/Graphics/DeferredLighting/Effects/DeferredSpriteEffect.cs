...
namespace Nez.DeferredLighting
{
    ...
    public class DeferredSpriteEffect : Effect
    {
        ...
        private bool _useNormalAlphaChannelForSelfIllumination;
        private float _selfIlluminationPower;

        private EffectParameter _normalMapParam;
        private EffectParameter _alphaCutoffParam;
        private EffectParameter _alphaAsSelfIlluminationParam;
        private EffectParameter _selfIlluminationPowerParam;

        public DeferredSpriteEffect() : base(EffectResource.DeferredSpriteEffect)
        {
